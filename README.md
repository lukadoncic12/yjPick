...
印记Pick项目是一个Spring Boot开发的前后端分离项目，使用了Redis集群、Tomcat集群、MySQL集群提高服务性能。类似于本地生活服务平台，实现了短信登录、商家查询缓存、优惠券秒杀、附近的商家、UV统计、用户签到、好友关注、达人探店八个部分形成了闭环。其中重点使用了分布式锁实现了一人一单功能，项目中大量使用了Redis的知识。

## 所用技术

*Spring Boot+Nginx+MySQL+Lombok+MyBatis-Plus+Hutool+Redis*
